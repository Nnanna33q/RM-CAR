        ...
        <div className="swiper-slide hero-container flex flex-col">
            ...
            <div className="w-[100vw] lg:h-[100vh] relative">
                ...
                <div className=".hero-main flex-grow text-very-light-gray flex items-center px-4 py-30 md:px-6 md:py-45 lg:px-10">
                    <div ref={heroRef} className={`flex flex-col gap-y-8`}>
                        <h1 className="hero-animate text-white text-5xl/15 md:text-6xl/15 lg:text-6xl/15 font-bold translate-y-16 opacity-0">Find
                            Your Next Ride
                        </h1>
                        <div className="hero-animate flex items-center gap-x-4 md:gap-x-6 lg:gap-x-8 text-medium-gray translate-y-16 opacity-0">
