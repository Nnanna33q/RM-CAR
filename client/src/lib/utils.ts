...
import type { GetCarsDataProp, GetEnquiriesDataProp, TBusinessInfo, TChartData, TRecentSales, Enquiry } from "./types";
...
export async function getBusinessInfo({ setLogo, setIsError, setBusinessInfo }: {
  ...
  setBusinessInfo: React.Dispatch<React.SetStateAction<TBusinessInfo | null>>,
}) {
  try {
...
export async function getDashboardInfo({ setTCars, setTEnquiries, setTSales, setIsError, setPercentageChangeOfSales, setPercentageChangeOfCars, setPercentageChangeOfEnquiries, setChartData, setRecentSales, setRecentEnquiries }: {
  setTCars: React.Dispatch<React.SetStateAction<number | null>>,
  setTEnquiries: React.Dispatch<React.SetStateAction<number | null>>,
  setTSales: React.Dispatch<React.SetStateAction<number | null>>,
  setIsError: React.Dispatch<React.SetStateAction<{
    error: boolean;
    errorMessage: string;
  }>>,
  ...
  setChartData: React.Dispatch<React.SetStateAction<TChartData[] | null>>
  setRecentSales: React.Dispatch<React.SetStateAction<TRecentSales[] | null>>,
  setRecentEnquiries: React.Dispatch<React.SetStateAction<Enquiry[] | undefined>>
}) {
  try {
